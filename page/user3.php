  ...
  <body>
  	<br><br><center><font color=green size=3><b>用 户 收 货 地 址 管 理</b></font></center><br>
		...
		<tr bgcolor="#6b8ba8" style="color:FFFFFF">
		    ...
		    <td width="15%" align="center" valign="bottom">详细地址</td>
		</tr>
		<?php
			require('1_init.php');
