...
<html>
  ...
  <body>
  	<br><br><center><font color=green size=3><b>用 户 资 料 修 改</b></font></center><br>
		...
		<tr bgcolor="#6b8ba8" style="color:FFFFFF">
		    ...
		    <td width="10%" align="center" valign="bottom">用户管理</td>
		</tr>
		<?php
			require('1_init.php');
		...
		<tr>
			...
			<td>
				<a href='user_delete.php?id=<?php echo $row['userid'];?>');\">删除</a>
				<a href='user_updata.php?id=<?php echo $row['userid'];?>');\">修改</a>
			</td>
		</tr>
		<?php    
			}
